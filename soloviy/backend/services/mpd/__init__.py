...
from soloviy.backend.protobufs.lib import ConnectionCredentials, ConnectionDetails, MpdServiceBase, ConnectionStatus
...
class MpdService(MpdServiceBase):
    ...
    async def connect(self, connection_credentials: ConnectionCredentials) -> ConnectionDetails:
